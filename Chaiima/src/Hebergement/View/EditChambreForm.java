 ...
 * @author 21628
 */
public class EditChambreForm extends Form{

    public EditChambreForm(Form previous,Chambre t) {
        /*
        Le paramètre previous définit l'interface(Form) précédente.
        Quelque soit l'interface faisant appel à AddChambre, on peut y revenir
        en utilisant le bouton back
        */
        setTitle("modifier chambre "+t.getType()+"");
        setLayout(BoxLayout.y());
        Button logos = new Button("Image");
        TextField tfPrix= new TextField(t.getPrix().toString());
                TextField tfDuree= new TextField(t.getDuree().toString());
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {       
                        ...
                        if( ServiceChambre.getInstance().editChambre(t)){
                            Dialog.show("Success","chambre modifié",new Command("OK"));
                        previous.showBack();}
                        else
