 ...
 * @author 21628
 */
public class ShowChambreForm extends Form{
    Form current ; 
    public ShowChambreForm(Form previous) {
        current = this;
                            ...
                            m.addPointerReleasedListener(new ActionListener() {
                                    ...
                                    public void actionPerformed(ActionEvent evt) {
                                        if (Dialog.show("Confirmation", "Que voulez vous faire ?", "Supprimer", "Modifier")) {
                                                ...
                                                if( ServiceChambre.getInstance().delChambre(p)){
                                                    {
                                                       Dialog.show("Success","La chambre "+p.getType()+" a été supprimé avec succées",new Command("OK"));
                                                       previous.showBack();
                                                    }
                                        }
                                    }
                                                ...
                                                EditChambreForm t = new EditChambreForm(current,p);
                                                 t.show();
                                        }
                                    }
                                });
